...
namespace ASCOM.RobertU3s1021.Camera
{
    //
    ...
    //
    // Your driver's DeviceID is ASCOM.RobertU3s1021.Camera
    //
    // The COM Guid attribute sets the CLSID for ASCOM.RobertU3s1021.Camera
    // The COM ClassInterface/None attribute prevents an empty interface called _RobertU3s1021 from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("9b7327d6-61f5-4761-999e-83cfc47e47a5")]
    [ProgId("ASCOM.RobertU3s1021.Camera")]
    [ServedClassName("ASCOM Camera Driver for RobertU3s1021")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Camera : ReferenceCountedObjectBase, ICameraV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RobertU3s1021"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Camera()
        {
            try
            {
                ...
                tl = new TraceLogger("", "RobertU3s1021.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.RobertU3s1021.Camera", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
