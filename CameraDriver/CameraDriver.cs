...
namespace ASCOM.RobertDo3Think_USB3_12M_Camera.Camera
{
    ...
    //
    // Your driver's DeviceID is ASCOM.RobertDo3Think_USB3_12M_Camera.Camera
    //
    // The COM Guid attribute sets the CLSID for ASCOM.RobertDo3Think_USB3_12M_Camera.Camera
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("9671fb55-7038-4cb1-9deb-f68a182ae9e4")]
    [ProgId("ASCOM.RobertDo3Think_USB3_12M_Camera.Camera")]
    [ServedClassName("ASCOM Camera Driver for RobertDo3Think_USB3_12M_Camera")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Camera : ReferenceCountedObjectBase, ICameraV3, IDisposable
    {
        ...
        public Camera()
        {
            try
            {
                ...
                tl = new TraceLogger("", "RobertDo3Think_USB3_12M_Camera.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
