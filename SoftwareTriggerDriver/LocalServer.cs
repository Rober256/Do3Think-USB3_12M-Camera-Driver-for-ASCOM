//
// ASCOM.RobertDo3Think_USB3_12M_Camera_Trigger.Camera Local COM Server
//
...
namespace ASCOM.LocalServer
{
    public static class Server
    {
        ...
        private static string localServerAppId = "{3b243193-f48b-4550-8243-d6ddbe446c48}"; // Our AppId
        ...
        static void Main(string[] args)
        {
            ...
            TL = new TraceLogger("", "RobertDo3Think_USB3_12M_Camera_Trigger.LocalServer")
            {
            ...
            Thread.CurrentThread.Name = "RobertDo3Think USB3 12M Trigger Local Server";
        ...
        private static void RegisterObjects()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error while registering the server:\n" + ex.ToString(), "ASCOM.RobertDo3Think_USB3_12M_Camera_Trigger.Camera", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
        ...
        private static void ElevateSelf(string argument)
        {
            ...
            {
                TL.LogMessage("IsAdministrator", $"The ASCOM.RobertDo3Think_USB3_12M_Camera_Trigger.Camera was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it."));
                MessageBox.Show("The ASCOM.RobertDo3Think_USB3_12M_Camera_Trigger.Camera was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it.", "ASCOM.RobertDo3Think_USB3_12M_Camera_Trigger.Camera", MessageBoxButtons.OK, MessageBoxIcon.Warning));
            }
            catch (Exception ex)
            {
                TL.LogMessageCrLf("IsAdministrator", $"Exception: {ex}");
                MessageBox.Show(ex.ToString(), "ASCOM.RobertDo3Think_USB3_12M_Camera_Trigger.Camera", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            return;
        }
        ...
        private static bool RegisterClassFactories()
        {
            ...
            foreach (Type driverType in driverTypes)
            {
                ...
                if (!factory.RegisterClassObject())
                {
                    ...
                    MessageBox.Show("Failed to register class factory for " + driverType.Name, "ASCOM.RobertDo3Think_USB3_12M_Camera_Trigger.Camera", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return false;
                }
            ...
            if (args.Length > 0)
            {
                switch (args[0].ToLower())
                {
                    ...
                    default:
                        ...
                        MessageBox.Show("Unknown argument: " + args[0] + "\nValid are : -register, -unregister and -embedding", "ASCOM.RobertDo3Think_USB3_12M_Camera_Trigger.Camera", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        break;
                }
            }
            else
