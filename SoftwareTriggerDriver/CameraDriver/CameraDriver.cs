...
namespace ASCOM.RobertDo3Think_USB3_12M_Camera_Trigger.Camera
{
    ...
    //
    // Your driver's DeviceID is ASCOM.RobertDo3Think_USB3_12M_Camera_Trigger.Camera
    //
    // The COM Guid attribute sets the CLSID for ASCOM.RobertDo3Think_USB3_12M_Camera_Trigger.Camera
    // The COM ClassInterface/None attribute prevents an empty interface called _RobertDo3Think_USB3_12M_Camera from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("3366af60-08dc-4c9c-bf2c-ce72ce3e7eb7")]
    [ProgId("ASCOM.RobertDo3Think_USB3_12M_Camera_Trigger.Camera")]
    [ServedClassName("RobertDo3Think USB3 12M Camera (Software Trigger)")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Camera : ReferenceCountedObjectBase, ICameraV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RobertDo3Think_USB3_12M_Camera"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Camera()
        {
            try
            {
                ...
                tl = new TraceLogger("", "RobertDo3Think_USB3_12M_Camera_Trigger.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
